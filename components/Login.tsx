  ...
  const renderLogin = () => (
      <>
        ...
        <div className="flex gap-2 mb-6">
             <button onClick={fillMockData} className="text-xs px-2 py-1 bg-gray-100 dark:bg-gray-700 rounded hover:bg-gray-200 dark:hover:bg-gray-600 dark:text-gray-300">Fill Admin</button>
        </div>
